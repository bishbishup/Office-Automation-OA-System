...
CREATE TABLE `sys_node`  (
  ...
  `node_name` varchar(32) CHARACTER SET utf8mb4 NOT NULL COMMENT '节点名称',
  `url` varchar(255) CHARACTER SET utf8mb4  NULL DEFAULT NULL COMMENT '功能地址',
...
CREATE TABLE `sys_role`  (
  ...
  `role_description` varchar(32) CHARACTER SET utf8mb4  NOT NULL COMMENT '角色描述',
