...
CREATE TABLE `adm_leave_form`  (
                                   ...
                                   `reason` varchar(128) CHARACTER SET utf8mb4  NOT NULL COMMENT '请假事由',
                                   `create_time` datetime(0) NOT NULL COMMENT '创建时间',
                                   `state` varchar(32) CHARACTER SET utf8mb4  NOT NULL COMMENT 'processing-正在审批 approved-审批已通过 refused-审批被驳回',
...
CREATE TABLE `adm_process_flow`  (
                                     ...
                                     `action` varchar(32) CHARACTER SET utf8mb4  NOT NULL COMMENT 'apply-申请  audit-审批',
                                     `result` varchar(32) CHARACTER SET utf8mb4  NULL DEFAULT NULL COMMENT 'approved-同意 refused-驳回',
                                     `reason` varchar(255) CHARACTER SET utf8mb4  NULL DEFAULT NULL COMMENT '审批意见',
                                     `create_time` datetime(0) NOT NULL COMMENT '创建时间',
                                     `audit_time` datetime(0) NULL DEFAULT NULL COMMENT '审批时间',
                                     `order_no` int(11) NOT NULL COMMENT '任务序号',
                                     `state` varchar(32) CHARACTER SET utf8mb4  NOT NULL COMMENT 'ready-准备 process-正在处理 complete-处理完成 cancel-取消',
                                     `is_last` int(255) NOT NULL COMMENT '是否最后节点,0-否 1-是',
                                     PRIMARY KEY (`process_id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 96 CHARACTER SET = utf8mb4  ROW_FORMAT = Dynamic;
